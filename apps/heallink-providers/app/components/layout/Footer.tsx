...
export default function Footer() {
  ...
  // Footer navigation sections for providers
  const footerSections = [
    ...
    },
    {
      ...
      links: [
        ...
        { name: "Provider Agreement", href: "/legal/provider-agreement" },
  ...
  const socialLinks = [
    ...
    {
      name: "YouTube",
      href: "https://youtube.com/heallink",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 24 24"
    ...
    <footer className="relative overflow-hidden">
      ...
      <div className="bg-gray-50 dark:bg-gray-900">
        ...
        <div className="container mx-auto px-6 pt-16 pb-12">
          {/* Top section with brand and theme toggle */}
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 mb-16">
            ...
            <div className="lg:col-span-2">
              ...
              <motion.p
                ...
                transition={{ duration: 0.3, delay: 0.1 }}
              >
                Empowering healthcare providers with intelligent tools for better patient care. 
                Join the future of healthcare delivery with HealLink's comprehensive platform.
              </motion.p>
          ...
          >
            ...
            >
              ...
              Provider Support: +353 874831977
            </a>
            <a
              href="mailto:providers@heallink.io"
              className="flex items-center text-gray-500 dark:text-gray-400 hover:text-purple-heart dark:hover:text-purple-heart transition-colors duration-200"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
          ...
          >
            <p className="text-gray-500 dark:text-gray-400">
              © {currentYear} HealLink Provider Portal. All rights reserved.
            </p>
