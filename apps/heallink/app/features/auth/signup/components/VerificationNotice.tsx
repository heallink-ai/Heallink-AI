...
export default function VerificationNotice({ email }: VerificationNoticeProps) {
  return (
    <div className="flex justify-center items-center w-full min-h-[80vh]">
      <div className="neumorph-flat bg-white dark:bg-gray-800 rounded-2xl p-8 max-w-md w-full mx-auto">
        <div className="text-center">
          ...
          <div className="mb-8 p-4 rounded-xl neumorph-pressed bg-gradient-to-r from-purple-heart/5 to-royal-blue/5">
            <h3 className="font-medium high-contrast-text mb-2">
              What's next?
            </h3>
            <p className="text-sm light-text-muted">
              After verifying your email, you can log in to access all features
              of Heallink. Verification helps us ensure the security of your
              account.
            </p>
          </div>
