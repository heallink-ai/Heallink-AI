...
export default function SignUpPage() {
  ...
  const handleSignUp = async (e: React.FormEvent) => {
    ...
    try {
      // Here you would implement your signup API call
      // For demo purposes, we'll just simulate it and redirect to signin
        ...
        <div>
          ...
          <form onSubmit={handleNextStep} className="space-y-6">
            ...
            <div className="text-center text-sm light-text-muted">
              ...
              <a href="/auth/signin" className="text-purple-heart hover:text-purple-heart-600 font-medium">
                Sign in
              </a>
            </div>
          </form>
          ...
          <div className="flex items-start">
            ...
            <div className="ml-3 text-sm">
              <label htmlFor="terms" className="light-text-muted text-xs">
                ...
                <a href="/terms-of-service" className="text-purple-heart hover:text-purple-heart-600">
                  Terms of Service
                </a>{" "}
                and{" "}
                <a href="/privacy-policy" className="text-purple-heart hover:text-purple-heart-600">
                  Privacy Policy
                </a>
              </label>
            </div>
