          ...
          <ScrollReveal direction="up" delay={300}>
            <div className="mb-8">
              <div className="relative bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-black rounded-2xl p-6 neumorph-flat">
                ...
                <div className="absolute -left-6 bottom-16 w-10 h-10 rounded-xl bg-gradient-to-br from-royal-blue to-havelock-blue neumorph-flat text-white flex items-center justify-center transform -rotate-12 animate-float" style={{ animationDelay: "2s" }}>
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
      ...
      <div className="w-full md:w-1/2 flex flex-col justify-center items-center p-6 md:p-10 lg:p-16">
        <div className="w-full max-w-md">
          ...
          <ScrollReveal direction="up" delay={100}>
            <h2 className="text-3xl md:text-4xl font-bold mb-3 high-contrast-text">{title}</h2>
          </ScrollReveal>
